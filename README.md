...
4. [Building](#building)
5. [DCM API](#dcm-api)
6. [Load balancer tutorial](#load-balancer-tutorial)
...
three methods: `Model.build()`, `model.updateData()` and `model.solve()`. There are several concepts
involved in using them, which we explain using the tutorial below.
