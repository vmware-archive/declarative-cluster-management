...
public class ScaleModelBenchmark {
    ...
    static int allowedNodes;
    @Param("10000")
    static int systemNodes;

    @State(Scope.Benchmark)
    public static class BenchmarkState {
        @Nullable DBConnectionPool dbConnectionPool = null;
        ...
        public void setUp() {
            ...
            for (int i = 0; i < systemNodes; i++) {
                // Add node.
                String nodeName = "node-" + i;
                if (i < allowedNodes) {
                    nodeName = "allowed-node-" + i;
                }
